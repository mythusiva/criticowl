...
<head>
    <meta charset="utf-8">
    <title><?=$this->config->item('window_title')?> - Admin New Article</title>
					...
					<div class='panel panel_spacing'>
						...
						<div class='panel-content form-horizontal'>
							<form id="form" method="POST" action='/admin/save_article'>
								...
								<div>
									<textarea class="ckeditor" name="article_content_field"><?=get_last_value($user_data,'article_content','');?></textarea class="ckeditor" >
								</div>
								<br />
								<div class='blurb'>
									<p>
