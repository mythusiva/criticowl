...
<head>
    <meta charset="utf-8">
    <title>Exclusive Updates | Articles | <?=$this->config->item('window_title')?></title>
...
<body>
	<h1 style="display:none">Exclusive Updates</h1>
	<?$config['access_level'] = 'USER';?>
	<?$this->load->view('snippets/top_bar',array('config'=>$config,'selected'=>'exclusive_articles'))?>
	<div class="main_body">
		<div class="main_content">
			...
			<div class="content_wrapper">
				...
				<div class="left_pane">
					...
					<div id="exclusive_articles_list_container" class="">
						<div class="title-medium title-box">Exclusive Articles</div>
						<div class="content">
					...
					<div class="show_more_button_container">
						<a class="show_more_btn btn btn-medium auto_load_feed" 
							data-update-selector="#exclusive_articles_list_container .content" 
							data-pagination-id="<?=SHOW_MORE_EXCLUSIVE_ARTICLES_LIST?>" 
							data-content-type="<?=POST_EXCLUSIVE_ARTICLE?>">Show More</a>
					</div>
				</div>
