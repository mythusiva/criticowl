...
<div class='review_container'>
	<table style="width:100%;">
		<tr>
			<td style="width: 25%;">
				<div onclick="window.location='/review/<?=$uri_segment?>'" class='pointer tile_img_thumbnail' style="background-image: url('<?=encodeURIComponent(get_compressed_image_url($image_link))?>');"></div>
			</td>
			<td style="width: 75%; vertical-align: middle; padding: 0px 15px;">
				<div class="preview-review-title center">
					<a href="/review/<?=$uri_segment?>"><?=$title?></a>
				</div>
